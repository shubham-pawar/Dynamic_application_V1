...
<h2 class="text-center">Registration Form</h2>       
        <div class="form-group">
            <input type="text" class="form-control" name="rno" placeholder="RNO" required="required">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="bal" placeholder="Balance" required="required">
        </div>
        <div class="form-group">
